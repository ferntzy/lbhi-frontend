    ...
    >
      ...
      <div
        style={{
          ...
          height: '2px',
          background:
            'linear-gradient(90deg, transparent, #4dd9d0, transparent)',
        }}
      />
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Serving the people of Southern Leyte with compassionate,
              accessible, and professional healthcare since our founding.
            </p>
        ...
        >
          ...
          >
            © {new Date().getFullYear()} Leyte Baptist Hospital. All rights
            reserved.
          </p>
      ...
      <style>{`
        ...
        .footer-link:hover .footer-link-caret,
        .footer-link:focus-visible .footer-link-caret {
          opacity: 1;
