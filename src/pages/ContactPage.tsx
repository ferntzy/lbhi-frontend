    ...
    <div style={{ paddingTop: "64px" }}>
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            ...
            />
            <span
              style={{ color: "#7fe3e0", fontSize: "13px", fontWeight: 600 }}
            >
              Emergency Line:
            </span>
            <span
      ...
      <div style={{ backgroundColor: "#0d2240", padding: "72px 24px" }}>
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          ...
          >
            For general inquiries, appointment information, and hospital
            services. For medical emergencies, please call our emergency line
            directly — do not wait for a response to a web form.
          </p>
        </div>
      </div>

      <div
        style={{ maxWidth: "1280px", margin: "0 auto", padding: "56px 24px" }}
      >
        <div
          style={{
            display: "grid",
          ...
          <div>
            ...
            >
              {[
                ...
                {
                  label: "Email",
                  value: "info@leytebaptisthospital.ph",
                  icon: "mail",
                  highlight: false,
                },
              ].map((contact) => (
          ...
          <div>
              ...
              {submitted ? (
                <div style={{ textAlign: "center", padding: "32px 0" }}>
                  ...
                  >
                    ...
                    respond to your inquiry within 1–2 business days.
                  </p>
                  <button
                ...
                <>
                  ...
                  >
                      ...
                      {[
                        ...
                        <div key={field.id}>
                          ...
                          <input
                            ...
                            onFocus={(e) =>
                              (e.target.style.borderColor = "#1a7f7a")
                            }
                            onBlur={(e) =>
                    ...
                    >
                      This form is for general inquiries only. For medical
                      emergencies, call our emergency line immediately. Do not
                      send patient medical records, diagnoses, or personal
            ...
            >
              ...
              <div style={{ fontSize: "13px" }}>
                Hilongos, Southern Leyte, Philippines
              </div>
              <div
                style={{ fontSize: "11px", color: "#1a7f7a", marginTop: "8px" }}
              >
